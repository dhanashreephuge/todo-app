        ...
        <main className="main-container">
            <div className="row g-4">
                {categories.map((cat) => (
                    ...
                    key={cat.title} 
                    onClick={() => setSelectedCategory(cat.title)} style={{cursor:'pointer'}}>
            ...
            <div className="mt-5 bg-white shadow rounded">
                <div className="d-flex justify-content-between align-items-center p-3 bg-warning rounded-top">
                    ...
                    <div>
                        ...
                        onClick={() => setSelectedCategory('All')}>All Task</button>
                        ...
                        filteredTask.map((task, idx) => (
                            ...
                            rounded mb-2 shadow-sm task-item" key={idx}>
                                <div>
                                    ...
                                    <br />
                                    <small className="text-muted">Added On: {formatDate(task.date)}</small>
                                </div>
